  ...
  return (
    <div className="space-y-6 sm:px-6 lg:col-span-8 lg:px-0">
      <div className="shadow sm:overflow-hidden sm:rounded-md">
        <div
          className="h-full animate-pulse space-y-6 rounded-md border-2 border-neutral-800
        bg-darkBG2 bg-gradient-to-r from-orange-300 via-darkBG2 to-black py-6 px-4
        shadow sm:p-6"
        >
          <div className="px-4 py-5 sm:p-6">
            <div className="mt-5 flex justify-evenly">
