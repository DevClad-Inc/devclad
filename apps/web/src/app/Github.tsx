...
export function GithubAuth() {
	...
	React.useEffect(() => {
		if (pathname.startsWith('/auth/complete/github/') && queryParams.get('code') !== null) {
	...
	return (
		<div className="mt-10 animate-pulse backdrop-blur-0">
			<div className="sm:mx-auto sm:w-full sm:max-w-full">
				...
				<h2 className="mt-5 text-center font-mono text-xl text-neutral-900 dark:text-white">
					<div className="flex justify-center">
						<svg
							className="mr-2 h-12 w-8 items-center sm:h-16 sm:w-10"
							aria-hidden="true"
							fill="currentColor"
							viewBox="0 0 20 20"
						>
