		...
		<Transition.Root show={open} as={Fragment} appear>
            ...
            transition-all"
						>
							...
							<div className="bg-darkBG2 flex flex-wrap items-center py-2.5 px-4 text-xs text-neutral-300">
								Press{' '}
								<kbd
									className={classNames(
							...
							<div className="bg-darkBG flex flex-wrap items-center justify-end py-2.5 px-4 text-xs text-neutral-300">
