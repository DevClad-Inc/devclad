...
export default function Tabs({ tabs }: { tabs: { name: string; href: string }[] }) {
	...
	return (
		<div className="mb-4 flex justify-center">
			<div
				className="bg-darkBG2 hover:bg-darkBG items-center space-x-4 rounded-md border-[1px] border-neutral-800
    p-3 text-sm shadow-2xl shadow-white/20 duration-1000 hover:border-neutral-700"
			>
