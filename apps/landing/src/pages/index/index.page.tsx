  ...
  return (
    ...
    >
      <div className="relative bg-gradient-to-tr from-black/80 to-black">
        ...
        <div className="absolute bottom-1/2 right-2 h-96 w-96 animate-blob animate-dropdarkglow rounded-full bg-gradient-to-tr from-sky-900/30 via-fuchsia-900/30 to-black opacity-50 mix-blend-difference blur-2xl filter" />
      </div>
    </div>
  );
}
