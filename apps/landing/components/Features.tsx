		...
		<div className="space-y-16 py-4 sm:animate-none sm:py-8">
			<div className="relative mx-auto max-w-xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
				...
				<div className="relative">
					...
					<p className=" font-sansNext mx-auto mt-4 max-w-3xl text-center text-lg text-neutral-200">
				...
				<div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
					<div className="relative">
						...
						<p className="font-monoNext mt-3 text-center text-lg tracking-tight text-neutral-200">
                       ...
                       border-[1px] border-dotted border-orange-200 bg-black p-4 shadow-lg"
											...
											<p className="font-monoNext mt-5 text-neutral-300 sm:text-sm lg:text-lg">
												{feature.description}
											</p>
										</div>
									</div>
	...
	return (
		<div className="animate-fadeIn space-y-16 py-4 sm:py-32">
			...
			<div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
				...
				<p className="font-monoNext mx-auto mt-5 max-w-prose text-xl text-neutral-300">
