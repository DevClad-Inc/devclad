			...
			<div className="flex justify-center py-10 font-mono">
				<span className="block text-amber-300">
					...
					<span className="block">
						<a href="/api/getpic"> Get a random userpic (Fetch)</a>
					</span>
					<span className="block">
						<a href="/api/avatar?stream=true"> Get an avatar (Fetch)</a>
					</span>
				</span>
			</div>

			<h2 className="flex justify-center text-2xl font-extrabold">Instructions</h2>
			<div className="flex justify-center py-5">
				<span className="block">
					Please check out the
					<a
						className="m-2 text-xl font-extrabold uppercase text-amber-300"
